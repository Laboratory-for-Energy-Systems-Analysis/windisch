...
#use the rotor diameter found in func_rotor_diameter in windisch code


from windisch.model import func_rotor_diameter  # Import at the top level

is_offshore = False  # Depends on the use case
power_output = 1500  # Input

# Coefficients for onshore or offshore turbines
if is_offshore:
    coeff_a, coeff_b, coeff_c, coeff_d = 191.83651588, 147.37205671, 5101.28555377, 376.62814798
else:
    coeff_a, coeff_b, coeff_c, coeff_d = 152.66222073, 136.56772435, 2478.03511414, 16.44042379

Drotor = func_rotor_diameter(power_output, coeff_a, coeff_b, coeff_c, coeff_d)
print(f"Calculated Rotor Diameter: {Drotor} m")
