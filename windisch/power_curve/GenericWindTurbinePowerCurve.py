...
# %% Complete model
def GenericWindTurbinePowerCurve(
    Vws,
    Pnom,
    Drotor,
    zhub=[],
    ...
    Pout_raw = WT_PowerCurve_raw(
        REWS, Pnom, Drotor, rMin, rMax, CpMax, Model, Beta, AirDensity, ConvEff
    )
