...
class ExportInventory:
    ...
    def __init__(self, array, indices, db_name="windisch export"):
        self.array = array
    ...
    def write_lci_to_excel(
        ...
        if software_compatibility == "brightway2":
            ...
            if export_format == "string":
                ...
                frmt = lambda x: bold if row[0] in highlighted else None
                sheet = workbook.add_worksheet("windisch export")
    ...
    def format_data_for_lci_for_simapro(self, data, ei_version):
        ...
        for a in data:
            ...
            for item in fields:
                ...
                if item == "Generator":
                    rows.append(["windisch " + str(__version__)])
        ...
        rows.append(["Description"])
        description = (
            "windisch: an open-source tool for prospective environmental and "
